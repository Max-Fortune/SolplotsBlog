...
date: "2023-08-20"
categories: [thoughts]
image: "NorthAtlanticAnomaly.jpg"
---
...
R reads in this data as a data frame, with the `name` column referring to year and the `data` column referring to a vector of temperature readings. This means we have a nested data frame that needs to be unnested. Let's also turn this into a tibble while we're at it.
